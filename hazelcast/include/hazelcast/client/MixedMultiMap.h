 ...
 */
#ifndef HAZELCAST_CLIENT_MIXEDMULTIMAP_H_
#define HAZELCAST_CLIENT_MIXEDMULTIMAP_H_
...
namespace hazelcast {
    namespace client {
        ...
        * @see IMap
        */
        class MixedMultiMap : public proxy::MultiMapImpl {
        ...
        private:
            MixedMultiMap(const std::string &instanceName, spi::ClientContext *context)
...
#endif /* HAZELCAST_CLIENT_MIXEDMULTIMAP_H_ */

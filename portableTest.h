...
//    SimpleDataSerializable sds(bytes);
//    TestRawDataPortable p(123213, chars, np, 22, "Testing raw portable", sds);
...
//    SerializationService serializationService(1, getPortableFactoryMap());
...
//    serialization::SerializationService serializationService(1, getPortableFactoryMap());
//
//    serialization::SerializationService serializationService2(2, getPortableFactoryMap2());
//
...
void testSerializationWithDifferentVersions() {
    serialization::SerializationService serializationService(1);

 ...
 */
#ifndef HAZELCAST_CLIENT_MIXEDLIST_H_
#define HAZELCAST_CLIENT_MIXEDLIST_H_
...
namespace hazelcast {
    namespace client {
        ...
        *
        */
        class HAZELCAST_API MixedList : public proxy::IListImpl {
        ...
        private:
            MixedList(const std::string &instanceName, spi::ClientContext *context);
        };
    }
}
...
#endif /* HAZELCAST_CLIENT_MIXEDLIST_H_ */

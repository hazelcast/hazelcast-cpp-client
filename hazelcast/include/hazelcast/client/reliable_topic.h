...
private:
    ...
    public:
            ...
            ringbuffer_->read_many(sequence_, 1, batch_size_)
              .then(executor_, [runner](boost::future<rb::read_result_set> f) {
                  ...
                  try {
                      ...
                      // we process all messages in batch. So we don't release the thread and
                      // reschedule ourselves; but we'll process whatever was received in 1 go.
                      auto lost_count = result.get_next_sequence_to_read_from() -
                      ...
                      for (size_t i = 0; i < items.size(); i++) {
                          ...
                          try {
                              ...
                              auto rel_msg =
                                message.get<topic::impl::reliable::ReliableTopicMessage>();
        ...
        /**
         * @param ie exception to check if it is terminal or can be handled so that topic can
         * continue

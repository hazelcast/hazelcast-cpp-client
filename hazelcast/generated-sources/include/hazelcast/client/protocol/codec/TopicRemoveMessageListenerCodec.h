 ...
 */
#ifndef HAZELCAST_CLIENT_PROTOCOL_CODEC_TOPICREMOVEMESSAGELISTENERCODEC_H_
#define HAZELCAST_CLIENT_PROTOCOL_CODEC_TOPICREMOVEMESSAGELISTENERCODEC_H_
...
namespace hazelcast {
    namespace client {
        ...
        namespace protocol {
            namespace codec {
                class HAZELCAST_API TopicRemoveMessageListenerCodec : public IRemoveListenerCodec{
                public:
                    virtual ~TopicRemoveMessageListenerCodec();
                    //************************ REQUEST STARTS ******************************************************************//
                    ...
                    TopicRemoveMessageListenerCodec (const std::string &name, const std::string &registrationId);
...
#endif /* HAZELCAST_CLIENT_PROTOCOL_CODEC_TOPICREMOVEMESSAGELISTENERCODEC_H_ */

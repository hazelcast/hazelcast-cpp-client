 ...
 */
#ifndef HAZELCAST_CLIENT_PROTOCOL_CODEC_QUEUEADDLISTENERCODEC_H_
#define HAZELCAST_CLIENT_PROTOCOL_CODEC_QUEUEADDLISTENERCODEC_H_
...
namespace hazelcast {
    namespace client {
        ...
        namespace protocol {
            namespace codec {
                class HAZELCAST_API QueueAddListenerCodec : public IAddListenerCodec{
                public:
                    virtual ~QueueAddListenerCodec();
                    //************************ REQUEST STARTS ******************************************************************//
                    ...
                    QueueAddListenerCodec (const std::string &name, const bool &includeValue, const bool &localOnly);
...
#endif /* HAZELCAST_CLIENT_PROTOCOL_CODEC_QUEUEADDLISTENERCODEC_H_ */

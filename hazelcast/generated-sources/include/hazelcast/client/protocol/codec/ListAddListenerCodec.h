 ...
 */
#ifndef HAZELCAST_CLIENT_PROTOCOL_CODEC_LISTADDLISTENERCODEC_H_
#define HAZELCAST_CLIENT_PROTOCOL_CODEC_LISTADDLISTENERCODEC_H_
...
namespace hazelcast {
    namespace client {
        ...
        namespace protocol {
            namespace codec {
                class HAZELCAST_API ListAddListenerCodec : public IAddListenerCodec{
                public:
                    virtual ~ListAddListenerCodec();
                    //************************ REQUEST STARTS ******************************************************************//
                    ...
                    ListAddListenerCodec (const std::string &name, const bool &includeValue, const bool &localOnly);
...
#endif /* HAZELCAST_CLIENT_PROTOCOL_CODEC_LISTADDLISTENERCODEC_H_ */

 ...
 */
#ifndef HAZELCAST_CLIENT_PROTOCOL_CODEC_REPLICATEDMAPREMOVEENTRYLISTENERCODEC_H_
#define HAZELCAST_CLIENT_PROTOCOL_CODEC_REPLICATEDMAPREMOVEENTRYLISTENERCODEC_H_
...
namespace hazelcast {
    namespace client {
        ...
        namespace protocol {
            namespace codec {
                class HAZELCAST_API ReplicatedMapRemoveEntryListenerCodec : public IRemoveListenerCodec{
                public:
                    virtual ~ReplicatedMapRemoveEntryListenerCodec();
                    //************************ REQUEST STARTS ******************************************************************//
                    ...
                    ReplicatedMapRemoveEntryListenerCodec (const std::string &name, const std::string &registrationId);
...
#endif /* HAZELCAST_CLIENT_PROTOCOL_CODEC_REPLICATEDMAPREMOVEENTRYLISTENERCODEC_H_ */

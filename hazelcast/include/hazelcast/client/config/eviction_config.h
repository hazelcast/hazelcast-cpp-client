...
public:
    ...
    {
        /**
         * Policy based on maximum number of entries stored per data structure
         * (map, cache etc)
         */
        ENTRY_COUNT
        /* TODO,
        *
         * Policy based on maximum used native memory in megabytes per data
        structure (map, cache etc)
         * on each Hazelcast instance

                USED_NATIVE_MEMORY_SIZE,
        *
         * Policy based on maximum used native memory percentage per data
        structure (map, cache etc)
         * on each Hazelcast instance

                USED_NATIVE_MEMORY_PERCENTAGE,
        *
         * Policy based on minimum free native memory in megabytes per Hazelcast
        instance

                FREE_NATIVE_MEMORY_SIZE,
        *
         * Policy based on minimum free native memory percentage per Hazelcast
        instance
    ...
    eviction_config& set_maximum_size_policy(
      const max_size_policy& max_size_policy);

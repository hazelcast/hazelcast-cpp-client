...
public:
    ...
    /**
     * connection_retry_config controls the period among the retries and when a client should give
     * up retrying. Exponential behaviour can be chosen or jitter can be added to wait periods.
     *

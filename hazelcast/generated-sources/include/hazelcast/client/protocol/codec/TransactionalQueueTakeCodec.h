 ...
 */
#ifndef HAZELCAST_CLIENT_PROTOCOL_CODEC_TRANSACTIONALQUEUETAKECODEC_H_
#define HAZELCAST_CLIENT_PROTOCOL_CODEC_TRANSACTIONALQUEUETAKECODEC_H_
...
namespace hazelcast {
    namespace client {
        ...
        namespace protocol {
            namespace codec {
                class HAZELCAST_API TransactionalQueueTakeCodec {
                public:

                    //************************ REQUEST STARTS ******************************************************************//
                    class HAZELCAST_API RequestParameters {
                        public:
                            static const enum TransactionalQueueMessageType TYPE;
...
#endif /* HAZELCAST_CLIENT_PROTOCOL_CODEC_TRANSACTIONALQUEUETAKECODEC_H_ */

...
public:
    /**
     * Gets the {@link com.hazelcast.monitor.NearCacheStats} instance to monitor
     * this store.
     *
...
/**
 * {@link NearCache} is the contract point to store keys and values in
 * underlying
 ...
 *
 * This is a no-op interface class. See InvalidationAwareNearCache for the
...
public:
    ...
    */
    ...
    /**
     * Gets the {@link com.hazelcast.config.InMemoryFormat} of the storage for
     * internal records.
     *
...
template class HAZELCAST_API
  NearCache<serialization::pimpl::data, serialization::pimpl::data>;

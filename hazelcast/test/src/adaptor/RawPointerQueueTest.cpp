    ...
    namespace client {
        namespace test {
            namespace adaptor {
                ...
                public:
                    RawPointerQueueTest() : instance(*g_srvFactory), client(getNewClient()),
                                            originalQueue(client->getQueue<std::string>("RawPointerQueueTest")),
                                            q(originalQueue) {
                    }
                ...
                protected:
                    ...
                    IQueue<std::string> originalQueue;
                    client::adaptor::RawPointerQueue<std::string> q;

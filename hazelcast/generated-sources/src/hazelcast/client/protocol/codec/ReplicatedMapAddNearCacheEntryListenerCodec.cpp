...
namespace hazelcast {
    namespace client {
        namespace protocol {
            namespace codec {
                const ReplicatedMapMessageType ReplicatedMapAddNearCacheEntryListenerCodec::RequestParameters::TYPE = HZ_REPLICATEDMAP_ADDNEARCACHEENTRYLISTENER;
                const bool ReplicatedMapAddNearCacheEntryListenerCodec::RequestParameters::RETRYABLE = false;
                const int32_t ReplicatedMapAddNearCacheEntryListenerCodec::ResponseParameters::TYPE = 104;

                ReplicatedMapAddNearCacheEntryListenerCodec::~ReplicatedMapAddNearCacheEntryListenerCodec() {
                }

                std::auto_ptr<ClientMessage> ReplicatedMapAddNearCacheEntryListenerCodec::RequestParameters::encode(
                        const std::string &name, 
                        bool includeValue, 
                        bool localOnly) {
                    int32_t requiredDataSize = calculateDataSize(name, includeValue, localOnly);
                    std::auto_ptr<ClientMessage> clientMessage = ClientMessage::createForEncode(requiredDataSize);
                    clientMessage->setMessageType((uint16_t)ReplicatedMapAddNearCacheEntryListenerCodec::RequestParameters::TYPE);
                ...
                int32_t ReplicatedMapAddNearCacheEntryListenerCodec::RequestParameters::calculateDataSize(
                        const std::string &name, 
                        bool includeValue, 
                        bool localOnly) {
                ...
                ReplicatedMapAddNearCacheEntryListenerCodec::ResponseParameters::ResponseParameters(ClientMessage &clientMessage) {
                    if (TYPE != clientMessage.getMessageType()) {
                        throw exception::UnexpectedMessageTypeException("ReplicatedMapAddNearCacheEntryListenerCodec::ResponseParameters::decode", clientMessage.getMessageType(), TYPE);
                    }
                ...
                ReplicatedMapAddNearCacheEntryListenerCodec::ResponseParameters::ResponseParameters(const ReplicatedMapAddNearCacheEntryListenerCodec::ResponseParameters &rhs) {
                ...
                void ReplicatedMapAddNearCacheEntryListenerCodec::AbstractEventHandler::handle(std::auto_ptr<protocol::ClientMessage> clientMessage) {
                    ...
                    switch (messageType) {
                        ...
                        default:
                            char buf[300];
                            util::snprintf(buf, 300, "[ReplicatedMapAddNearCacheEntryListenerCodec::AbstractEventHandler::handle] Unknown message type (%d) received on event handler.", clientMessage->getMessageType());
                            util::ILogger::getLogger().warning(buf);
                    }
                }
                //************************ EVENTS END **************************************************************************//

                ReplicatedMapAddNearCacheEntryListenerCodec::ReplicatedMapAddNearCacheEntryListenerCodec (const std::string &name, const bool &includeValue, const bool &localOnly)
                        : name_(name), includeValue_(includeValue), localOnly_(localOnly) {
                }

                //************************ IAddListenerCodec interface start ************************************************//
                std::auto_ptr<ClientMessage> ReplicatedMapAddNearCacheEntryListenerCodec::encodeRequest() const {
                    return RequestParameters::encode(name_, includeValue_, localOnly_);
                }

                std::string ReplicatedMapAddNearCacheEntryListenerCodec::decodeResponse(ClientMessage &responseMessage) const {

 ...
 */
#ifndef HAZELCAST_CLIENT_PROTOCOL_CODEC_QUEUEREMOVELISTENERCODEC_H_
#define HAZELCAST_CLIENT_PROTOCOL_CODEC_QUEUEREMOVELISTENERCODEC_H_
...
#include "hazelcast/client/protocol/codec/QueueMessageType.h"
...
namespace hazelcast {
    namespace client {
        ...
        namespace protocol {
            namespace codec {
                class HAZELCAST_API QueueRemoveListenerCodec : public IRemoveListenerCodec{
                public:
                    virtual ~QueueRemoveListenerCodec();
                    //************************ REQUEST STARTS ******************************************************************//
                    class HAZELCAST_API RequestParameters {
                        public:
                            static const enum QueueMessageType TYPE;
                    ...
                    QueueRemoveListenerCodec (const std::string &name, const std::string &registrationId);
...
#endif /* HAZELCAST_CLIENT_PROTOCOL_CODEC_QUEUEREMOVELISTENERCODEC_H_ */

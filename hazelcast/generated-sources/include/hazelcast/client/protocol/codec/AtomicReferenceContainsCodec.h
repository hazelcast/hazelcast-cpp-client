 ...
 */
#ifndef HAZELCAST_CLIENT_PROTOCOL_CODEC_ATOMICREFERENCECONTAINSCODEC_H_
#define HAZELCAST_CLIENT_PROTOCOL_CODEC_ATOMICREFERENCECONTAINSCODEC_H_
...
namespace hazelcast {
    namespace client {
        ...
        namespace protocol {
            namespace codec {
                class HAZELCAST_API AtomicReferenceContainsCodec {
                public:
...
#endif /* HAZELCAST_CLIENT_PROTOCOL_CODEC_ATOMICREFERENCECONTAINSCODEC_H_ */

...
public:
    ...
    /**
     * Returns memory cost (number of bytes) of Near Cache entries owned by this
     * member.
     *
     * @return memory cost (number of bytes) of Near Cache entries owned by this
     * member.
     */
    virtual int64_t get_owned_entry_memory_cost() = 0;

    /**
     * Returns the number of hits (reads) of Near Cache entries owned by this
     * member.
     *
     * @return number of hits (reads) of Near Cache entries owned by this
     * member.
     */
    ...
    /**
     * Returns the number of evictions of Near Cache entries owned by this
     * member.
     *
    ...
    /**
     * Returns the number of TTL and max-idle expirations of Near Cache entries
     * owned by this member.
     *
     * @return number of TTL and max-idle expirations of Near Cache entries
     * owned by this member.
     */
    virtual int64_t get_expirations() = 0;

    /**
     * Returns the number of invalidations of Near Cache entries owned by this
     * member.
     *
     * @return number of invalidations of Near Cache entries owned by this
     * member
     */
    virtual int64_t get_invalidations() = 0;

    /**
     * Returns the number of Near Cache key persistences (when the pre-load
     * feature is enabled).
     *
    ...
    /**
     * Returns the timestamp of the last Near Cache key persistence (when the
    ...
    /**
     * Returns the duration in milliseconds of the last Near Cache key
     * persistence (when the pre-load feature is enabled).
     *
     * @return the duration of the last Near Cache key persistence (in
     * milliseconds)
     */
    virtual int64_t get_last_persistence_duration() = 0;

    /**
     * Returns the written bytes of the last Near Cache key persistence (when
     * the pre-load feature is enabled).
     *
    ...
    /**
     * Returns the number of persisted keys of the last Near Cache key
     * persistence (when the pre-load feature is enabled).
     *
     * @return the number of persisted keys of the last Near Cache key
     * persistence
     */
    virtual int64_t get_last_persistence_key_count() = 0;

    /**
     * Returns the failure reason of the last Near Cache persistence (when the
     * pre-load feature is enabled).
     *

 ...
 */
#ifndef HAZELCAST_CLIENT_PROTOCOL_CODEC_MAPCLEARNEARCACHECODEC_H_
#define HAZELCAST_CLIENT_PROTOCOL_CODEC_MAPCLEARNEARCACHECODEC_H_
...
namespace hazelcast {
    namespace client {
        ...
        namespace protocol {
            namespace codec {
                class HAZELCAST_API MapClearNearCacheCodec {
                public:
...
#endif /* HAZELCAST_CLIENT_PROTOCOL_CODEC_MAPCLEARNEARCACHECODEC_H_ */

...
public:
     ...
     * <p>
     * The add_membership_listener method returns a registeration ID. This ID is
     needed to remove the membership_listener using the
     ...
     * &) \param registrationId the registrationId of membership_listener to
     * remove \return true if the registration is removed, false otherwise
     *
     */

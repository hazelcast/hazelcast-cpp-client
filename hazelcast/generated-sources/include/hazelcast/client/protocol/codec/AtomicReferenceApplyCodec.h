 ...
 */
#ifndef HAZELCAST_CLIENT_PROTOCOL_CODEC_ATOMICREFERENCEAPPLYCODEC_H_
#define HAZELCAST_CLIENT_PROTOCOL_CODEC_ATOMICREFERENCEAPPLYCODEC_H_
...
namespace hazelcast {
    namespace client {
        ...
        namespace protocol {
            namespace codec {
                class HAZELCAST_API AtomicReferenceApplyCodec {
                public:
...
#endif /* HAZELCAST_CLIENT_PROTOCOL_CODEC_ATOMICREFERENCEAPPLYCODEC_H_ */

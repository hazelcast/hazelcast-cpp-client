        ...
        public:
            ...
            */
            boost::future<boost::uuids::uuid> add_item_listener(item_listener &&listener, bool include_value) {
                std::unique_ptr<impl::item_event_handler<protocol::codec::set_addlistener_handler>> itemEventHandler(
                        new impl::item_event_handler<protocol::codec::set_addlistener_handler>(

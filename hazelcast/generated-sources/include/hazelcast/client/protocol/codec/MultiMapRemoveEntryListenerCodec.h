 ...
 */
#ifndef HAZELCAST_CLIENT_PROTOCOL_CODEC_MULTIMAPREMOVEENTRYLISTENERCODEC_H_
#define HAZELCAST_CLIENT_PROTOCOL_CODEC_MULTIMAPREMOVEENTRYLISTENERCODEC_H_
...
namespace hazelcast {
    namespace client {
        ...
        namespace protocol {
            namespace codec {
                class HAZELCAST_API MultiMapRemoveEntryListenerCodec : public IRemoveListenerCodec{
                public:
                    virtual ~MultiMapRemoveEntryListenerCodec();
                    //************************ REQUEST STARTS ******************************************************************//
                    ...
                    MultiMapRemoveEntryListenerCodec (const std::string &name, const std::string &registrationId);
...
#endif /* HAZELCAST_CLIENT_PROTOCOL_CODEC_MULTIMAPREMOVEENTRYLISTENERCODEC_H_ */

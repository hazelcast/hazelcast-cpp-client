 ...
 */
#ifndef HAZELCAST_CLIENT_QUERY_INPREDICATE_H_
#define HAZELCAST_CLIENT_QUERY_INPREDICATE_H_
...
namespace hazelcast {
    namespace client {
        namespace query {
             ...
             */
            template <typename T>
            class InPredicate : public serialization::IdentifiedDataSerializable {
            public:
                /**
                ...
                void readData(serialization::ObjectDataInput &in) {
                    ...
                    throw exception::IException("InPredicate::readData",
...
#endif /* HAZELCAST_CLIENT_QUERY_INPREDICATE_H_ */

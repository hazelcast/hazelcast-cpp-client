...
namespace hazelcast {
    namespace client {
        ...
        namespace protocol {
            namespace codec {
                class HAZELCAST_API MultiMapAddEntryListenerCodec : public IAddListenerCodec{
                public:
                    virtual ~MultiMapAddEntryListenerCodec();
                    //************************ REQUEST STARTS ******************************************************************//
                    ...
                    MultiMapAddEntryListenerCodec (const std::string &name, const bool &includeValue, const bool &localOnly);

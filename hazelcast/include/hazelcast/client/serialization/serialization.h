...
public:
     ...
     */
    object_data_input(boost::endian::order byte_order,
...
public:
    ...
    {
        object_data_output output(serialization_config_.get_byte_order(),
                                  false,
                            ...
                            boost::optional<T>>::type inline to_object(const data& data)
    {
        ...
        object_data_input objectDataInput(serialization_config_.get_byte_order(),
                                          data.to_byte_array(),
                                          8,
                                          portable_serializer_,
                                          data_serializer_,

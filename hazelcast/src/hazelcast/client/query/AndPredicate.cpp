    ...
    namespace client {
        namespace query {
            AndPredicate::AndPredicate(
                    const std::vector<const serialization::IdentifiedDataSerializable *> &predicatesVector)
                    : predicates(predicatesVector) {
            }
            ...
            void AndPredicate::writeData(serialization::ObjectDataOutput &out) const {
                ...
                for (std::vector<const serialization::IdentifiedDataSerializable *>::const_iterator it = predicates.begin();

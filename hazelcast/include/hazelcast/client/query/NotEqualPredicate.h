 ...
 */
#ifndef HAZELCAST_CLIENT_QUERY_NOTEQUALPREDICATE_H_
        ...
        namespace query {
            ...
            public:
                ...
                int getClassId() const {
                    return impl::predicates::NOTEQUAL_PREDICATE;
                }
                ...
                void readData(serialization::ObjectDataInput &in) {
                    ...
                    BOOST_THROW_EXCEPTION(exception::HazelcastSerializationException("NotEqualPredicate::readData",
...
#endif /* HAZELCAST_CLIENT_QUERY_NOTEQUALPREDICATE_H_ */

 ...
 */
#ifndef HAZELCAST_CLIENT_PROTOCOL_CODEC_MAPADDENTRYLISTENERTOKEYWITHPREDICATECODEC_H_
#define HAZELCAST_CLIENT_PROTOCOL_CODEC_MAPADDENTRYLISTENERTOKEYWITHPREDICATECODEC_H_
...
namespace hazelcast {
    namespace client {
        ...
        namespace protocol {
            namespace codec {
                class HAZELCAST_API MapAddEntryListenerToKeyWithPredicateCodec : public IAddListenerCodec{
                public:
                    virtual ~MapAddEntryListenerToKeyWithPredicateCodec();
                    //************************ REQUEST STARTS ******************************************************************//
                    ...
                    MapAddEntryListenerToKeyWithPredicateCodec (const std::string &name, const serialization::pimpl::Data &key, const serialization::pimpl::Data &predicate, const bool &includeValue, const int32_t &listenerFlags, const bool &localOnly);
...
#endif /* HAZELCAST_CLIENT_PROTOCOL_CODEC_MAPADDENTRYLISTENERTOKEYWITHPREDICATECODEC_H_ */

...
public:
    ...
    {
        boost::endian::endian_store<boost::uint16_t, 2, boost::endian::order::little>(
          wr_ptr(UINT16_SIZE), value);
    }

    inline void set(int16_t value)
    {
        boost::endian::endian_store<boost::int16_t, 2, boost::endian::order::little>(
          wr_ptr(INT16_SIZE), value);
    }

    inline void set(uint32_t value)
    {
        boost::endian::endian_store<boost::uint32_t, 4, boost::endian::order::little>(
    ...
    {
        boost::endian::endian_store<boost::uint64_t, 8, boost::endian::order::little>(

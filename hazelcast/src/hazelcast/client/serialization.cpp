...
data_output::write(int16_t value)
{
    ...
    output_stream_.insert(
      output_stream_.end(), (byte*)&value, (byte*)&value + util::Bits::SHORT_SIZE_IN_BYTES);
}
...
data_output::write(int32_t value, boost::endian::order byte_order)
{
    ...
    output_stream_.insert(
      output_stream_.end(), (byte*)&value, (byte*)&value + util::Bits::INT_SIZE_IN_BYTES);
}
...
data_output::write(int64_t value)
{
    ...
    output_stream_.insert(
      output_stream_.end(), (byte*)&value, (byte*)&value + util::Bits::LONG_SIZE_IN_BYTES);
}

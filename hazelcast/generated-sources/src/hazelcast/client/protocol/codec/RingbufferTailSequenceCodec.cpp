    ...
    namespace client {
        namespace protocol {
            namespace codec {
                ...
                RingbufferTailSequenceCodec::ResponseParameters::ResponseParameters(ClientMessage &clientMessage) {
                    if (RESPONSE_TYPE != clientMessage.getMessageType()) {
                        throw exception::UnexpectedMessageTypeException(
                                "RingbufferTailSequenceCodec::ResponseParameters::decode",
                ...
                RingbufferTailSequenceCodec::ResponseParameters::ResponseParameters(
                        const RingbufferTailSequenceCodec::ResponseParameters &rhs) {

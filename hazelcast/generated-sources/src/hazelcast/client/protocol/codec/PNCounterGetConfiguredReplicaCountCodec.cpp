        ...
        namespace protocol {
            namespace codec {
                ...
                int32_t PNCounterGetConfiguredReplicaCountCodec::calculateDataSize(
                    ...
                    PNCounterGetConfiguredReplicaCountCodec::ResponseParameters::ResponseParameters(ClientMessage &clientMessage) {
                    ...
                    PNCounterGetConfiguredReplicaCountCodec::ResponseParameters PNCounterGetConfiguredReplicaCountCodec::ResponseParameters::decode(ClientMessage &clientMessage) {

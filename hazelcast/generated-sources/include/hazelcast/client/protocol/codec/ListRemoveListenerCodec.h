 ...
 */
#ifndef HAZELCAST_CLIENT_PROTOCOL_CODEC_LISTREMOVELISTENERCODEC_H_
#define HAZELCAST_CLIENT_PROTOCOL_CODEC_LISTREMOVELISTENERCODEC_H_
...
namespace hazelcast {
    namespace client {
        ...
        namespace protocol {
            namespace codec {
                class HAZELCAST_API ListRemoveListenerCodec : public IRemoveListenerCodec{
                public:
                    virtual ~ListRemoveListenerCodec();
                    //************************ REQUEST STARTS ******************************************************************//
                    ...
                    ListRemoveListenerCodec (const std::string &name, const std::string &registrationId);
...
#endif /* HAZELCAST_CLIENT_PROTOCOL_CODEC_LISTREMOVELISTENERCODEC_H_ */

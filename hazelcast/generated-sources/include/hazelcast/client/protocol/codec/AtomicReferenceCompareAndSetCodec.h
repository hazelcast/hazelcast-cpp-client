 ...
 */
#ifndef HAZELCAST_CLIENT_PROTOCOL_CODEC_ATOMICREFERENCECOMPAREANDSETCODEC_H_
#define HAZELCAST_CLIENT_PROTOCOL_CODEC_ATOMICREFERENCECOMPAREANDSETCODEC_H_
...
namespace hazelcast {
    namespace client {
        ...
        namespace protocol {
            namespace codec {
                class HAZELCAST_API AtomicReferenceCompareAndSetCodec {
                public:
                    ...
                    private:
                        // Preventing public access to constructors
                        AtomicReferenceCompareAndSetCodec ();
                };
            }
        }
    }
...
#endif /* HAZELCAST_CLIENT_PROTOCOL_CODEC_ATOMICREFERENCECOMPAREANDSETCODEC_H_ */

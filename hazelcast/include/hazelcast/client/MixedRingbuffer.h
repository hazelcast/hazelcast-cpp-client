 ...
 */
#ifndef HZELCAST_CLIENT_MIXEDRINGBUFFER_H_
#define HZELCAST_CLIENT_MIXEDRINGBUFFER_H_
...
namespace hazelcast {
    namespace client {
         ...
         *
         */
        class HAZELCAST_API MixedRingbuffer : public proxy::ProxyImpl {
        public:
            MixedRingbuffer(const std::string &objectName, spi::ClientContext *context);

            virtual ~MixedRingbuffer();
...
#endif //HZELCAST_CLIENT_MIXEDRINGBUFFER_H_

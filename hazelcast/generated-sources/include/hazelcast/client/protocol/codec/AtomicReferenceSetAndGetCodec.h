 ...
 */
#ifndef HAZELCAST_CLIENT_PROTOCOL_CODEC_ATOMICREFERENCESETANDGETCODEC_H_
#define HAZELCAST_CLIENT_PROTOCOL_CODEC_ATOMICREFERENCESETANDGETCODEC_H_
...
namespace hazelcast {
    namespace client {
        ...
        namespace protocol {
            namespace codec {
                class HAZELCAST_API AtomicReferenceSetAndGetCodec {
                public:
...
#endif /* HAZELCAST_CLIENT_PROTOCOL_CODEC_ATOMICREFERENCESETANDGETCODEC_H_ */

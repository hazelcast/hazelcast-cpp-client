    ...
    namespace client {
        namespace protocol {
            namespace codec {
                ...
                AtomicLongGetCodec::ResponseParameters::ResponseParameters(ClientMessage &clientMessage) {
                    if (RESPONSE_TYPE != clientMessage.getMessageType()) {
                        throw exception::UnexpectedMessageTypeException(
                                "AtomicLongGetCodec::ResponseParameters::decode", clientMessage.getMessageType(),
                                RESPONSE_TYPE);
                    }
                ...
                AtomicLongGetCodec::ResponseParameters::ResponseParameters(
                        const AtomicLongGetCodec::ResponseParameters &rhs) {

 ...
 */
#ifndef HAZELCAST_CLIENT_PROTOCOL_CODEC_TRANSACTIONALMAPGETFORUPDATECODEC_H_
#define HAZELCAST_CLIENT_PROTOCOL_CODEC_TRANSACTIONALMAPGETFORUPDATECODEC_H_
...
namespace hazelcast {
    namespace client {
        ...
        namespace protocol {
            namespace codec {
                class HAZELCAST_API TransactionalMapGetForUpdateCodec {
                public:
...
#endif /* HAZELCAST_CLIENT_PROTOCOL_CODEC_TRANSACTIONALMAPGETFORUPDATECODEC_H_ */

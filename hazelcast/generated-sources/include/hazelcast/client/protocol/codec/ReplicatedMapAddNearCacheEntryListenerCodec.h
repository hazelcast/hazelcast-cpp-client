 ...
 */
#ifndef HAZELCAST_CLIENT_PROTOCOL_CODEC_REPLICATEDMAPADDNEARCACHEENTRYLISTENERCODEC_H_
#define HAZELCAST_CLIENT_PROTOCOL_CODEC_REPLICATEDMAPADDNEARCACHEENTRYLISTENERCODEC_H_
...
namespace hazelcast {
    namespace client {
        ...
        namespace protocol {
            namespace codec {
                class HAZELCAST_API ReplicatedMapAddNearCacheEntryListenerCodec : public IAddListenerCodec{
                public:
                    virtual ~ReplicatedMapAddNearCacheEntryListenerCodec();
                    //************************ REQUEST STARTS ******************************************************************//
                    ...
                    ReplicatedMapAddNearCacheEntryListenerCodec (const std::string &name, const bool &includeValue, const bool &localOnly);
...
#endif /* HAZELCAST_CLIENT_PROTOCOL_CODEC_REPLICATEDMAPADDNEARCACHEENTRYLISTENERCODEC_H_ */

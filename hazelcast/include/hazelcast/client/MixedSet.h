 ...
 */
#ifndef HAZELCAST_CLIENT_MIXEDSET_H_
#define HAZELCAST_CLIENT_MIXEDSET_H_
...
namespace hazelcast {
    namespace client {
        ...
        *
        */
        class HAZELCAST_API MixedSet : public proxy::ISetImpl {
        ...
        private:
            MixedSet(const std::string &instanceName, spi::ClientContext *context);
        };
    }
}
...
#endif /* HAZELCAST_CLIENT_MIXEDSET_H_ */

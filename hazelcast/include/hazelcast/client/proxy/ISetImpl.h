...
protected:
    ...
    boost::future<bool> contains_all(
      const std::vector<serialization::pimpl::data>& elements);

    boost::future<bool> add_all(
      const std::vector<serialization::pimpl::data>& elements);

    boost::future<bool> remove_all(
      const std::vector<serialization::pimpl::data>& elements);

    boost::future<bool> retain_all(
      const std::vector<serialization::pimpl::data>& elements);

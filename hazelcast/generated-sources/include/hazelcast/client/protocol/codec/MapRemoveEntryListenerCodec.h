 ...
 */
#ifndef HAZELCAST_CLIENT_PROTOCOL_CODEC_MAPREMOVEENTRYLISTENERCODEC_H_
#define HAZELCAST_CLIENT_PROTOCOL_CODEC_MAPREMOVEENTRYLISTENERCODEC_H_
...
namespace hazelcast {
    namespace client {
        ...
        namespace protocol {
            namespace codec {
                class HAZELCAST_API MapRemoveEntryListenerCodec : public IRemoveListenerCodec{
                public:
                    virtual ~MapRemoveEntryListenerCodec();
                    //************************ REQUEST STARTS ******************************************************************//
                    ...
                    MapRemoveEntryListenerCodec (const std::string &name, const std::string &registrationId);
...
#endif /* HAZELCAST_CLIENT_PROTOCOL_CODEC_MAPREMOVEENTRYLISTENERCODEC_H_ */

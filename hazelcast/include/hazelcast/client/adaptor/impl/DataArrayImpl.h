...
//
#ifndef HAZELCAST_CLIENT_ADAPTOR_IMPL_DATAARRAYIMPL_H_
#define HAZELCAST_CLIENT_ADAPTOR_IMPL_DATAARRAYIMPL_H_
...
#endif //HAZELCAST_CLIENT_ADAPTOR_IMPL_DATAARRAYIMPL_H_

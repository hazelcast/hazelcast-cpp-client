 ...
 */
#ifndef HAZELCAST_CLIENT_PROTOCOL_CODEC_REPLICATEDMAPADDENTRYLISTENERTOKEYCODEC_H_
#define HAZELCAST_CLIENT_PROTOCOL_CODEC_REPLICATEDMAPADDENTRYLISTENERTOKEYCODEC_H_
...
namespace hazelcast {
    namespace client {
        ...
        namespace protocol {
            namespace codec {
                class HAZELCAST_API ReplicatedMapAddEntryListenerToKeyCodec : public IAddListenerCodec{
                public:
                    virtual ~ReplicatedMapAddEntryListenerToKeyCodec();
                    //************************ REQUEST STARTS ******************************************************************//
                    ...
                    ReplicatedMapAddEntryListenerToKeyCodec (const std::string &name, const serialization::pimpl::Data &key, const bool &localOnly);
...
#endif /* HAZELCAST_CLIENT_PROTOCOL_CODEC_REPLICATEDMAPADDENTRYLISTENERTOKEYCODEC_H_ */

 ...
 */
#ifndef HAZELCAST_CLIENT_PROTOCOL_CODEC_TRANSACTIONALQUEUEPEEKCODEC_H_
#define HAZELCAST_CLIENT_PROTOCOL_CODEC_TRANSACTIONALQUEUEPEEKCODEC_H_
...
namespace hazelcast {
    namespace client {
        ...
        namespace protocol {
            namespace codec {
                class HAZELCAST_API TransactionalQueuePeekCodec {
                public:
...
#endif /* HAZELCAST_CLIENT_PROTOCOL_CODEC_TRANSACTIONALQUEUEPEEKCODEC_H_ */

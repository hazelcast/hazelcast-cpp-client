...
#ifndef HAZELCAST_CLIENT_TOPIC_RELIABLEMESSAGELISTENER_H_
#define HAZELCAST_CLIENT_TOPIC_RELIABLEMESSAGELISTENER_H_
    ...
    namespace client {
        namespace topic {
            ...
            public:
                 ...
                 */
                virtual int64_t retrieveInitialSequence() const = 0;
                 ...
                 */
                virtual void storeSequence(int64_t sequence) = 0;
                 ...
                 */
                virtual bool isLossTolerant() const = 0;
                 ...
                 */
                virtual bool isTerminal(const exception::IException &failure) const = 0;
            };
...
#endif //HAZELCAST_CLIENT_TOPIC_RELIABLEMESSAGELISTENER_H_

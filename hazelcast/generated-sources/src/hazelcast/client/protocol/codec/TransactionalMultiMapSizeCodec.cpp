    ...
    namespace client {
        namespace protocol {
            namespace codec {
                ...
                std::auto_ptr<ClientMessage> TransactionalMultiMapSizeCodec::encodeRequest(
                ...
                TransactionalMultiMapSizeCodec::ResponseParameters::ResponseParameters(ClientMessage &clientMessage) {
                    if (RESPONSE_TYPE != clientMessage.getMessageType()) {
                        throw exception::UnexpectedMessageTypeException(
                                "TransactionalMultiMapSizeCodec::ResponseParameters::decode",
                ...
                TransactionalMultiMapSizeCodec::ResponseParameters::ResponseParameters(
                        const TransactionalMultiMapSizeCodec::ResponseParameters &rhs) {

    ...
    namespace client {
        ...
        */
        ...
        public:
            ...
            *
            *      hazelcast::util::SharedPtr<int> e = list.get(5);
            *      if(e.get() != NULL )
            *          //......;
            *
            * @param index
            ...
            *
            */
            hazelcast::util::SharedPtr<E> get(int index) {
                return hazelcast::util::SharedPtr<E>(toObject<E>(proxy::IListImpl::getData(index)));
            }
            ...
            * @throws IndexOutOfBoundsException if the index is out of range.
            */
            hazelcast::util::SharedPtr<E> set(int index, const E &element) {
                return hazelcast::util::SharedPtr<E>(toObject<E>(proxy::IListImpl::setData(index, toData(element))));
            }
            ...
            * @throws IndexOutOfBoundsException if the index is out of range.
            */
            hazelcast::util::SharedPtr<E> remove(int index) {
                return hazelcast::util::SharedPtr<E>(toObject<E>(proxy::IListImpl::removeData(index)));
            }

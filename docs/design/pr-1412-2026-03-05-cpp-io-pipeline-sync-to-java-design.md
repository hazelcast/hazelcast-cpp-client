...
**Status:** Approved \
**Base branch:** `master`) \
**PR:** [#1412](https://github.com/hazelcast/hazelcast-cpp-client/pull/1412) \
**Goal:** Close the 4.3x throughput gap (103K vs 446K ops/sec PUT 4B) by aligning C++ client networking architecture
with Java client.

## Problem

After the IO thread count fix ([PR](https://github.com/hazelcast/hazelcast-cpp-client/pull/1410)), C++ client throughput
plateaus at ~103K ops/sec for PUT 4B values with 240
...
All changes build on top of branch `fixIoThreadCount` [PR](https://github.com/hazelcast/hazelcast-cpp-client/pull/144),

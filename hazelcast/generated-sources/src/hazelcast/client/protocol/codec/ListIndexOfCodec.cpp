    ...
    namespace client {
        namespace protocol {
            namespace codec {
                ...
                std::auto_ptr<ClientMessage> ListIndexOfCodec::encodeRequest(
                ...
                ListIndexOfCodec::ResponseParameters::ResponseParameters(ClientMessage &clientMessage) {
                    if (RESPONSE_TYPE != clientMessage.getMessageType()) {
                        throw exception::UnexpectedMessageTypeException("ListIndexOfCodec::ResponseParameters::decode",
                ...
                ListIndexOfCodec::ResponseParameters::ResponseParameters(
                        const ListIndexOfCodec::ResponseParameters &rhs) {

...
public:
    ...
    virtual bool shutdownMember(const std::string& clusterId,
                                const std::string& memberId) = 0;
    virtual bool terminateMember(const std::string& clusterId,
                                 const std::string& memberId) = 0;
    virtual bool suspendMember(const std::string& clusterId,
                               const std::string& memberId) = 0;
    virtual bool resumeMember(const std::string& clusterId,
                              const std::string& memberId) = 0;
    virtual bool shutdownCluster(const std::string& clusterId) = 0;
    virtual bool terminateCluster(const std::string& clusterId) = 0;
    virtual void splitMemberFromCluster(Cluster& _return,
                                        const std::string& memberId) = 0;
...
class RemoteControllerIfSingletonFactory
  : virtual public RemoteControllerIfFactory
{
public:
...
public:
    ...
    bool shutdownMember(const std::string& /* clusterId */,
                        const std::string& /* memberId */)
    {
        bool _return = false;
        return _return;
    }
    bool terminateMember(const std::string& /* clusterId */,
                         const std::string& /* memberId */)
    {
        bool _return = false;
        return _return;
    }
    bool suspendMember(const std::string& /* clusterId */,
                       const std::string& /* memberId */)
    {
        bool _return = false;
        return _return;
    }
    bool resumeMember(const std::string& /* clusterId */,
                      const std::string& /* memberId */)
    {
        bool _return = false;
        return _return;
    ...
    void splitMemberFromCluster(Cluster& /* _return */,
                                const std::string& /* memberId */)
    {
        return;
    }
...
public:
    ...
    RemoteController_ping_result& operator=(
...
public:
    ...
    RemoteController_clean_result& operator=(
...
public:
    ...
    RemoteController_exit_result& operator=(
...
public:
    RemoteController_createCluster_args(
      const RemoteController_createCluster_args&);
    RemoteController_createCluster_args& operator=(
      const RemoteController_createCluster_args&);
    RemoteController_createCluster_args()
      : hzVersion()
      , xmlconfig()
...
public:
    RemoteController_createCluster_result(
      const RemoteController_createCluster_result&);
    RemoteController_createCluster_result& operator=(
      const RemoteController_createCluster_result&);
    RemoteController_createCluster_result() {}
...
public:
    ...
    bool operator==(
      const RemoteController_createClusterKeepClusterName_args& rhs) const
    {
        if (!(hzVersion == rhs.hzVersion))
            return false;
        if (!(xmlconfig == rhs.xmlconfig))
    ...
    bool operator<(
      const RemoteController_createClusterKeepClusterName_args&) const;
...
public:
    ...
    bool operator==(
      const RemoteController_createClusterKeepClusterName_result& rhs) const
    {
        if (!(success == rhs.success))
            return false;
        if (!(serverException == rhs.serverException))
    ...
    bool operator<(
      const RemoteController_createClusterKeepClusterName_result&) const;
...
public:
    ...
    RemoteController_startMember_args& operator=(
...
public:
    RemoteController_startMember_result(
      const RemoteController_startMember_result&);
    RemoteController_startMember_result& operator=(
      const RemoteController_startMember_result&);
    RemoteController_startMember_result() {}
...
public:
    RemoteController_shutdownMember_args(
      const RemoteController_shutdownMember_args&);
    RemoteController_shutdownMember_args& operator=(
      const RemoteController_shutdownMember_args&);
    RemoteController_shutdownMember_args()
      : clusterId()
      , memberId()
...
public:
    RemoteController_terminateMember_args(
      const RemoteController_terminateMember_args&);
    RemoteController_terminateMember_args& operator=(
      const RemoteController_terminateMember_args&);
    RemoteController_terminateMember_args()
      : clusterId()
      , memberId()
...
public:
    RemoteController_suspendMember_args(
      const RemoteController_suspendMember_args&);
    RemoteController_suspendMember_args& operator=(
      const RemoteController_suspendMember_args&);
    RemoteController_suspendMember_args()
      : clusterId()
      , memberId()
...
public:
    ...
    RemoteController_suspendMember_result& operator=(
      const RemoteController_suspendMember_result&);
    RemoteController_suspendMember_result()
      : success(0)
    {}
...
public:
    RemoteController_resumeMember_args(
      const RemoteController_resumeMember_args&);
    RemoteController_resumeMember_args& operator=(
      const RemoteController_resumeMember_args&);
    RemoteController_resumeMember_args()
      : clusterId()
      , memberId()
...
public:
    ...
    RemoteController_resumeMember_result& operator=(
      const RemoteController_resumeMember_result&);
    RemoteController_resumeMember_result()
      : success(0)
    {}
...
public:
    ...
    RemoteController_shutdownCluster_args& operator=(
      const RemoteController_shutdownCluster_args&);
    RemoteController_shutdownCluster_args()
      : clusterId()
    {}
...
public:
    ...
    bool operator==(
      const RemoteController_splitMemberFromCluster_args& rhs) const
    {
        if (!(memberId == rhs.memberId))
            return false;
        return true;
...
public:
    ...
    bool operator==(
      const RemoteController_splitMemberFromCluster_result& rhs) const
    {
        if (!(success == rhs.success))
            return false;
        return true;
...
public:
    ...
    bool operator==(
      const RemoteController_mergeMemberToCluster_result& rhs) const
    {
        if (!(success == rhs.success))
            return false;
        return true;
...
public:
    ...
    bool operator==(
      const RemoteController_executeOnController_result& rhs) const
    {
        if (!(success == rhs.success))
            return false;
        return true;
...
public:
    ...
    void createCluster(Cluster& _return,
                       const std::string& hzVersion,
                       const std::string& xmlconfig);
    void send_createCluster(const std::string& hzVersion,
                            const std::string& xmlconfig);
    ...
    bool shutdownMember(const std::string& clusterId,
                        const std::string& memberId);
    void send_shutdownMember(const std::string& clusterId,
                             const std::string& memberId);
    bool recv_shutdownMember();
    bool terminateMember(const std::string& clusterId,
                         const std::string& memberId);
    void send_terminateMember(const std::string& clusterId,
                              const std::string& memberId);
    bool recv_terminateMember();
    bool suspendMember(const std::string& clusterId,
                       const std::string& memberId);
    void send_suspendMember(const std::string& clusterId,
                            const std::string& memberId);
    bool recv_suspendMember();
    bool resumeMember(const std::string& clusterId,
                      const std::string& memberId);
    void send_resumeMember(const std::string& clusterId,
                           const std::string& memberId);
    ...
    void mergeMemberToCluster(Cluster& _return,
                              const std::string& clusterId,
                              const std::string& memberId);
    void send_mergeMemberToCluster(const std::string& clusterId,
                                   const std::string& memberId);
...
private:
    ...
    void process_createCluster(int32_t seqid,
                               ...
                               ::apache::thrift::protocol::TProtocol* oprot,
                               void* callContext);
    void process_createClusterKeepClusterName(
      int32_t seqid,
      ::apache::thrift::protocol::TProtocol* iprot,
      ::apache::thrift::protocol::TProtocol* oprot,
      void* callContext);
    ...
    void process_terminateCluster(int32_t seqid,
                                  ...
                                  ::apache::thrift::protocol::TProtocol* oprot,
                                  void* callContext);
    void process_splitMemberFromCluster(
      int32_t seqid,
      ::apache::thrift::protocol::TProtocol* iprot,
      ::apache::thrift::protocol::TProtocol* oprot,
      void* callContext);
    void process_mergeMemberToCluster(
      int32_t seqid,
      ::apache::thrift::protocol::TProtocol* iprot,
      ::apache::thrift::protocol::TProtocol* oprot,
      void* callContext);
    void process_executeOnController(
      int32_t seqid,
      ::apache::thrift::protocol::TProtocol* iprot,
      ::apache::thrift::protocol::TProtocol* oprot,
      void* callContext);
...
class RemoteControllerProcessorFactory
...
public:
                                      ...
                                      const std::string& xmlconfig)
    {
        ...
        size_t i = 0;
        for (; i < (sz - 1); ++i) {
            ifaces_[i]->createClusterKeepClusterName(
              _return, hzVersion, xmlconfig);
        }
...
public:
    ...
    void createCluster(Cluster& _return,
                       const std::string& hzVersion,
                       const std::string& xmlconfig);
    int32_t send_createCluster(const std::string& hzVersion,
                               const std::string& xmlconfig);
    ...
    bool shutdownMember(const std::string& clusterId,
                        const std::string& memberId);
    int32_t send_shutdownMember(const std::string& clusterId,
                                const std::string& memberId);
    bool recv_shutdownMember(const int32_t seqid);
    bool terminateMember(const std::string& clusterId,
                         const std::string& memberId);
    int32_t send_terminateMember(const std::string& clusterId,
                                 const std::string& memberId);
    bool recv_terminateMember(const int32_t seqid);
    bool suspendMember(const std::string& clusterId,
                       const std::string& memberId);
    int32_t send_suspendMember(const std::string& clusterId,
                               const std::string& memberId);
    bool recv_suspendMember(const int32_t seqid);
    bool resumeMember(const std::string& clusterId,
                      const std::string& memberId);
    int32_t send_resumeMember(const std::string& clusterId,
                              const std::string& memberId);
    ...
    void mergeMemberToCluster(Cluster& _return,
                              const std::string& clusterId,
                              const std::string& memberId);
    int32_t send_mergeMemberToCluster(const std::string& clusterId,
                                      const std::string& memberId);

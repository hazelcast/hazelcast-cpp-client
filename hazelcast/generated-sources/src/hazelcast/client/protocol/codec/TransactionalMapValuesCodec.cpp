    ...
    namespace client {
        namespace protocol {
            namespace codec {
                ...
                TransactionalMapValuesCodec::ResponseParameters::ResponseParameters(ClientMessage &clientMessage) {
                    if (RESPONSE_TYPE != clientMessage.getMessageType()) {
                        throw exception::UnexpectedMessageTypeException(
                                "TransactionalMapValuesCodec::ResponseParameters::decode",
                ...
                TransactionalMapValuesCodec::ResponseParameters::ResponseParameters(
                        const TransactionalMapValuesCodec::ResponseParameters &rhs) {

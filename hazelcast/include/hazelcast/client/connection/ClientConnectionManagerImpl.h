        ...
        namespace connection {
            ...
            */
            ...
            private:
                ...
                logger &logger_;
                std::chrono::milliseconds connectionTimeoutMillis_;
                spi::ClientContext &client_;
                std::unique_ptr<boost::asio::io_context> ioContext_;
                SocketInterceptor socketInterceptor_;
                spi::impl::ClientExecutionServiceImpl &executionService_;
                std::shared_ptr<AddressTranslator> translator_;
                util::SynchronizedMap<boost::uuids::uuid, Connection, boost::hash<boost::uuids::uuid>> activeConnections_;
                ...
                util::ConcurrentSet<std::shared_ptr<ConnectionListener> > connectionListeners_;
                ...
                int32_t ioThreadCount_;
                bool shuffleMemberList_;
                std::vector<std::shared_ptr<AddressProvider> > addressProviders_;
                std::atomic<int32_t> connectionIdGen_;
                std::unique_ptr<boost::asio::ip::tcp::resolver> ioResolver_;
                std::unique_ptr<internal::socket::SocketFactory> socketFactory_;
                HeartbeatManager heartbeat_;
                std::vector<std::thread> ioThreads_;
                std::unique_ptr<boost::asio::io_context::work> ioGuard_;

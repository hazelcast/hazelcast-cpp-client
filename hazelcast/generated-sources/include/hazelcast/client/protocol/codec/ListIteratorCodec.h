 ...
 */
#ifndef HAZELCAST_CLIENT_PROTOCOL_CODEC_LISTITERATORCODEC_H_
#define HAZELCAST_CLIENT_PROTOCOL_CODEC_LISTITERATORCODEC_H_
...
namespace hazelcast {
    namespace client {
        ...
        namespace protocol {
            namespace codec {
                class HAZELCAST_API ListIteratorCodec {
                public:
...
#endif /* HAZELCAST_CLIENT_PROTOCOL_CODEC_LISTITERATORCODEC_H_ */

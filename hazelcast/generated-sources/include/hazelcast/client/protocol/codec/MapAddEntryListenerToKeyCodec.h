 ...
 */
#ifndef HAZELCAST_CLIENT_PROTOCOL_CODEC_MAPADDENTRYLISTENERTOKEYCODEC_H_
#define HAZELCAST_CLIENT_PROTOCOL_CODEC_MAPADDENTRYLISTENERTOKEYCODEC_H_
...
namespace hazelcast {
    namespace client {
        ...
        namespace protocol {
            namespace codec {
                class HAZELCAST_API MapAddEntryListenerToKeyCodec : public IAddListenerCodec{
                public:
                    virtual ~MapAddEntryListenerToKeyCodec();
                    //************************ REQUEST STARTS ******************************************************************//
                    ...
                    MapAddEntryListenerToKeyCodec (const std::string &name, const serialization::pimpl::Data &key, const bool &includeValue, const int32_t &listenerFlags, const bool &localOnly);
...
#endif /* HAZELCAST_CLIENT_PROTOCOL_CODEC_MAPADDENTRYLISTENERTOKEYCODEC_H_ */

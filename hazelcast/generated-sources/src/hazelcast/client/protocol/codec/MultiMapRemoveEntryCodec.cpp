    ...
    namespace client {
        namespace protocol {
            namespace codec {
                ...
                MultiMapRemoveEntryCodec::ResponseParameters::ResponseParameters(ClientMessage &clientMessage) {
                    if (RESPONSE_TYPE != clientMessage.getMessageType()) {
                        throw exception::UnexpectedMessageTypeException(
                                "MultiMapRemoveEntryCodec::ResponseParameters::decode", clientMessage.getMessageType(),
                                RESPONSE_TYPE);
                    }
                ...
                MultiMapRemoveEntryCodec::ResponseParameters::ResponseParameters(
                        const MultiMapRemoveEntryCodec::ResponseParameters &rhs) {

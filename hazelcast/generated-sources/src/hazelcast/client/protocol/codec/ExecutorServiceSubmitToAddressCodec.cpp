...
namespace hazelcast {
    namespace client {
        namespace protocol {
            namespace codec {
                const ExecutorServiceMessageType ExecutorServiceSubmitToAddressCodec::RequestParameters::TYPE = HZ_EXECUTORSERVICE_SUBMITTOADDRESS;
                const bool ExecutorServiceSubmitToAddressCodec::RequestParameters::RETRYABLE = false;
                const int32_t ExecutorServiceSubmitToAddressCodec::ResponseParameters::TYPE = 105;
                std::auto_ptr<ClientMessage> ExecutorServiceSubmitToAddressCodec::RequestParameters::encode(
                    ...
                    clientMessage->setMessageType((uint16_t)ExecutorServiceSubmitToAddressCodec::RequestParameters::TYPE);
                ...
                int32_t ExecutorServiceSubmitToAddressCodec::RequestParameters::calculateDataSize(
                        const std::string &name, 
                        const std::string &uuid, 
                        const serialization::pimpl::Data &callable, 
                        const Address &address) {
                ...
                ExecutorServiceSubmitToAddressCodec::ResponseParameters::ResponseParameters(ClientMessage &clientMessage) {
                    if (TYPE != clientMessage.getMessageType()) {
                        throw exception::UnexpectedMessageTypeException("ExecutorServiceSubmitToAddressCodec::ResponseParameters::decode", clientMessage.getMessageType(), TYPE);
                    }

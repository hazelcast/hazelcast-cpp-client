    ...
    namespace client {
        ...
        namespace spi {
            ...
            private :
                ...
                boost::shared_future<serialization::Data> doSend(std::auto_ptr<const impl::PortableRequest>, std::auto_ptr<impl::BaseEventHandler>, boost::shared_ptr<connection::Connection>);

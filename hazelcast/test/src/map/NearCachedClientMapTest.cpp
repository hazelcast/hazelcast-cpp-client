 ...
 */
//
// Created by ihsan demir on 15 Dec 2016.
...
namespace hazelcast {
    namespace client {
        namespace test {
            class NearCachedClientMapTest : public ClientTestSupport {
            protected:
                ...
                static void SetUpTestCase() {
                    ...
                    const char *intMapName = "IntMap";
                    const char *employeesMapName = "EmployeesMap";
                    const char *imapName = "clientMapTest";
                    clientConfig->addAddress(Address(g_srvFactory->getServerAddress(), 5701));

                    boost::shared_ptr<config::NearCacheConfig> intMapNearCacheConfig(
                            new config::NearCacheConfig(intMapName));
                    clientConfig->addNearCacheConfig(intMapNearCacheConfig);

                    boost::shared_ptr<config::NearCacheConfig> employeesCacheConfig(
                            new config::NearCacheConfig(employeesMapName));
                    clientConfig->addNearCacheConfig(employeesCacheConfig);

                    boost::shared_ptr<config::NearCacheConfig> imapNearCacheConfig(
                            new config::NearCacheConfig(imapName));
                    clientConfig->addNearCacheConfig(imapNearCacheConfig);
            ...
            HazelcastServer *NearCachedClientMapTest::instance = NULL;
            HazelcastServer *NearCachedClientMapTest::instance2 = NULL;
            ClientConfig *NearCachedClientMapTest::clientConfig = NULL;
            HazelcastClient *NearCachedClientMapTest::client = NULL;
            IMap<std::string, std::string> *NearCachedClientMapTest::imap = NULL;
            IMap<int, int> *NearCachedClientMapTest::intMap = NULL;
            IMap<int, Employee> *NearCachedClientMapTest::employees = NULL;

            TEST_F(NearCachedClientMapTest, testIssue537) {
            ...
            TEST_F(NearCachedClientMapTest, testContains) {
                fillMap();
            ...
            TEST_F(NearCachedClientMapTest, testGet) {
                fillMap();
                for (int i = 0; i < 10; i++) {
                    std::string key = "key";
                    key += util::IOUtil::to_string(i);
            ...
            TEST_F(NearCachedClientMapTest, testRemoveAndDelete) {
                fillMap();
            ...
            TEST_F(NearCachedClientMapTest, testRemoveIfSame) {
                fillMap();
            ...
            TEST_F(NearCachedClientMapTest, testGetAllPutAll) {
            ...
            TEST_F(NearCachedClientMapTest, testTryPutRemove) {
            ...
            TEST_F(NearCachedClientMapTest, testPutTtl) {
            ...
            TEST_F(NearCachedClientMapTest, testPutConfigTtl) {
            ...
            TEST_F(NearCachedClientMapTest, testPutIfAbsent) {
            ...
            TEST_F(NearCachedClientMapTest, testPutIfAbsentTtl) {
            ...
            TEST_F(NearCachedClientMapTest, testSet) {
            ...
            TEST_F(NearCachedClientMapTest, testSetTtl) {
                IMap<std::string, std::string> map = client->getMap<std::string, std::string>("OneSecondTtlMap");
                util::CountDownLatch dummy(10);
                util::CountDownLatch evict(1);
                CountdownListener<std::string, std::string> sampleEntryListener(dummy, dummy, dummy, evict);
            ...
            TEST_F(NearCachedClientMapTest, testSetConfigTtl) {
                IMap<std::string, std::string> map = client->getMap<std::string, std::string>("OneSecondTtlMap");
                util::CountDownLatch dummy(10);
                util::CountDownLatch evict(1);
                CountdownListener<std::string, std::string> sampleEntryListener(dummy, dummy, dummy, evict);
            ...
            TEST_F(NearCachedClientMapTest, testLock) {
            ...
            TEST_F(NearCachedClientMapTest, testLockTtl) {
                imap->put("key1", "value1");
                ASSERT_EQ("value1", *(imap->get("key1")));
            ...
            TEST_F(NearCachedClientMapTest, testLockTtl2) {
            ...
            TEST_F(NearCachedClientMapTest, testTryLock) {
            ...
            TEST_F(NearCachedClientMapTest, testForceUnlock) {
                imap->lock("key1");
                util::CountDownLatch latch(1);
            ...
            TEST_F(NearCachedClientMapTest, testValues) {
                fillMap();
            ...
            TEST_F(NearCachedClientMapTest, testValuesWithPredicate) {
            ...
            TEST_F(NearCachedClientMapTest, testValuesWithPagingPredicate) {
                int predSize = 5;
            ...
            TEST_F(NearCachedClientMapTest, testKeySetWithPredicate) {
                const int numItems = 20;
                for (int i = 0; i < numItems; ++i) {
                    intMap->put(i, 2 * i);
                }
            ...
            TEST_F(NearCachedClientMapTest, testKeySetWithPagingPredicate) {
                int predSize = 5;
                const int totalEntries = 25;
            ...
            TEST_F(NearCachedClientMapTest, testEntrySetWithPredicate) {
                const int numItems = 20;
            ...
            TEST_F(NearCachedClientMapTest, testEntrySetWithPagingPredicate) {
                int predSize = 5;
                const int totalEntries = 25;
            ...
            TEST_F(NearCachedClientMapTest, testReplace) {
            ...
            TEST_F(NearCachedClientMapTest, testListenerWithPortableKey) {
            ...
            TEST_F(NearCachedClientMapTest, testListener) {
            ...
            TEST_F(NearCachedClientMapTest, testListenerWithTruePredicate) {
            ...
            TEST_F(NearCachedClientMapTest, testListenerWithFalsePredicate) {
                util::CountDownLatch latchAdd(3);
                util::CountDownLatch latchRemove(1);
                util::CountDownLatch latchEvict(1);
                util::CountDownLatch latchUpdate(1);
            ...
            TEST_F(NearCachedClientMapTest, testListenerWithEqualPredicate) {
            ...
            TEST_F(NearCachedClientMapTest, testListenerWithNotEqualPredicate) {
            ...
            TEST_F(NearCachedClientMapTest, testListenerWithGreaterLessPredicate) {
                util::CountDownLatch latchAdd(2);
                util::CountDownLatch latchRemove(1);
                util::CountDownLatch latchEvict(1);
                util::CountDownLatch latchUpdate(1);
            ...
            TEST_F(NearCachedClientMapTest, testListenerWithBetweenPredicate) {
                util::CountDownLatch latchAdd(2);
                util::CountDownLatch latchRemove(1);
                util::CountDownLatch latchEvict(1);
                util::CountDownLatch latchUpdate(1);
            ...
            TEST_F(NearCachedClientMapTest, testListenerWithSqlPredicate) {
                util::CountDownLatch latchAdd(1);
                util::CountDownLatch latchRemove(1);
                util::CountDownLatch latchEvict(1);
                util::CountDownLatch latchUpdate(1);
            ...
            TEST_F(NearCachedClientMapTest, testListenerWithRegExPredicate) {
                util::CountDownLatch latchAdd(2);
                util::CountDownLatch latchRemove(1);
                util::CountDownLatch latchEvict(1);
                util::CountDownLatch latchUpdate(1);
            ...
            TEST_F(NearCachedClientMapTest, testListenerWithInstanceOfPredicate) {
                util::CountDownLatch latchAdd(3);
                util::CountDownLatch latchRemove(1);
                util::CountDownLatch latchEvict(1);
                util::CountDownLatch latchUpdate(1);
            ...
            TEST_F(NearCachedClientMapTest, testListenerWithNotPredicate) {
                util::CountDownLatch latchAdd(2);
                util::CountDownLatch latchRemove(1);
                util::CountDownLatch latchEvict(1);
                util::CountDownLatch latchUpdate(1);
            ...
            TEST_F(NearCachedClientMapTest, testListenerWithAndPredicate) {
                util::CountDownLatch latchAdd(1);
                util::CountDownLatch latchRemove(1);
                util::CountDownLatch latchEvict(1);
                util::CountDownLatch latchUpdate(1);
            ...
            TEST_F(NearCachedClientMapTest, testListenerWithOrPredicate) {
                util::CountDownLatch latchAdd(2);
                util::CountDownLatch latchRemove(1);
                util::CountDownLatch latchEvict(1);
                util::CountDownLatch latchUpdate(1);
            ...
            TEST_F(NearCachedClientMapTest, testClearEvent) {
                util::CountDownLatch latch(1);
            ...
            TEST_F(NearCachedClientMapTest, testEvictAllEvent) {
                util::CountDownLatch latch(1);
            ...
            TEST_F(NearCachedClientMapTest, testMapWithPortable) {
            ...
            TEST_F(NearCachedClientMapTest, testMapStoreRelatedRequests) {
            ...
            TEST_F(NearCachedClientMapTest, testExecuteOnKey) {
                Employee empl1("ahmet", 35);
                Employee empl2("mehmet", 21);
            ...
            TEST_F(NearCachedClientMapTest, testExecuteOnNonExistentKey) {
                EntryMultiplier processor(4);
            ...
            TEST_F(NearCachedClientMapTest, testExecuteOnEntries) {
                Employee empl1("ahmet", 35);
                Employee empl2("mehmet", 21);
                Employee empl3("deniz", 25);
            ...
            TEST_F(NearCachedClientMapTest, testExecuteOnEntriesWithTruePredicate) {
                Employee empl1("ahmet", 35);
                Employee empl2("mehmet", 21);
                Employee empl3("deniz", 25);
            ...
            TEST_F(NearCachedClientMapTest, testExecuteOnEntriesWithFalsePredicate) {
                Employee empl1("ahmet", 35);
                Employee empl2("mehmet", 21);
                Employee empl3("deniz", 25);
            ...
            TEST_F(NearCachedClientMapTest, testExecuteOnEntriesWithAndPredicate) {
                Employee empl1("ahmet", 35);
                Employee empl2("mehmet", 21);
                Employee empl3("deniz", 25);
            ...
            TEST_F(NearCachedClientMapTest, testExecuteOnEntriesWithOrPredicate) {
                Employee empl1("ahmet", 35);
                Employee empl2("mehmet", 21);
                Employee empl3("deniz", 25);
            ...
            TEST_F(NearCachedClientMapTest, testExecuteOnEntriesWithBetweenPredicate) {
                Employee empl1("ahmet", 35);
                Employee empl2("mehmet", 21);
                Employee empl3("deniz", 25);
            ...
            TEST_F(NearCachedClientMapTest, testExecuteOnEntriesWithEqualPredicate) {
                Employee empl1("ahmet", 35);
                Employee empl2("mehmet", 21);
                Employee empl3("deniz", 25);
            ...
            TEST_F(NearCachedClientMapTest, testExecuteOnEntriesWithNotEqualPredicate) {
                Employee empl1("ahmet", 35);
                Employee empl2("mehmet", 21);
                Employee empl3("deniz", 25);
            ...
            TEST_F(NearCachedClientMapTest, testExecuteOnEntriesWithGreaterLessPredicate) {
                Employee empl1("ahmet", 35);
                Employee empl2("mehmet", 21);
                Employee empl3("deniz", 25);
            ...
            TEST_F(NearCachedClientMapTest, testExecuteOnEntriesWithLikePredicate) {
                Employee empl1("ahmet", 35);
                Employee empl2("mehmet", 21);
                Employee empl3("deniz", 25);
            ...
            TEST_F(NearCachedClientMapTest, testExecuteOnEntriesWithILikePredicate) {
                Employee empl1("ahmet", 35);
                Employee empl2("mehmet", 21);
                Employee empl3("deniz", 25);
            ...
            TEST_F(NearCachedClientMapTest, testExecuteOnEntriesWithInPredicate) {
                Employee empl1("ahmet", 35);
                Employee empl2("mehmet", 21);
                Employee empl3("deniz", 25);
            ...
            TEST_F(NearCachedClientMapTest, testExecuteOnEntriesWithInstanceOfPredicate) {
                Employee empl1("ahmet", 35);
                Employee empl2("mehmet", 21);
                Employee empl3("deniz", 25);
            ...
            TEST_F(NearCachedClientMapTest, testExecuteOnEntriesWithNotPredicate) {
                Employee empl1("ahmet", 35);
                Employee empl2("mehmet", 21);
                Employee empl3("deniz", 25);
            ...
            TEST_F(NearCachedClientMapTest, testExecuteOnEntriesWithRegexPredicate) {
                Employee empl1("ahmet", 35);
                Employee empl2("mehmet", 21);
                Employee empl3("deniz", 25);
            ...
            TEST_F(NearCachedClientMapTest, testAddInterceptor) {

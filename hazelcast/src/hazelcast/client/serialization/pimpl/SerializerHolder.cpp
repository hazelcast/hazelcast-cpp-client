    ...
    namespace client {
        namespace serialization {
            namespace pimpl {
                ...
                bool SerializerHolder::registerSerializer(hazelcast::util::SharedPtr<SerializerBase> serializer) {
                    hazelcast::util::SharedPtr<SerializerBase> available = serializers.putIfAbsent(serializer->getHazelcastTypeId(), serializer);
                    return available.get() == NULL;
                }

                hazelcast::util::SharedPtr<SerializerBase> SerializerHolder::serializerFor(int typeId) {

...
namespace config {
/**
 * Client connection strategy configuration is used for setting custom
 * strategies and configuring strategy parameters.
 */
...
public:
    ...
    enum reconnect_mode
    {
        ...
        ON,
        /**
         * Reconnect to cluster without blocking invocations. Invocations will
         * receive
    ...
    /**
     * Client instance creation won't block on {@link
     * hazelcast_client(ClientConfig &)} if this value is true
     ...
     * This parameter is used by default strategy and custom implementations may
     * ignore it if configured. default value is {@link ReconnectMode#ON}
     * @param reconnectMode
     * @return the updated ClientConnectionStrategyConfig
     */
    ...
    /**
     * connection_retry_config controls the period among the retries and when a
     * client should give up retrying. Exponential behaviour can be chosen or
     * jitter can be added to wait periods.
     *
     * @return connection_retry_config the connection retry config to read or
     * modify.
     */
     ...
     * jitter can be added to wait periods.
     *
     * @param connection_retry_config the connection retry config to read or
     * modify.

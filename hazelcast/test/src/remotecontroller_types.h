 ...
 *  @generated
 */
#ifndef remotecontroller_TYPES_H
#define remotecontroller_TYPES_H
...
inline std::ostream& operator<<(std::ostream& out, const Cluster& obj)
{
  obj.printTo(out);
  return out;
}
...
inline std::ostream& operator<<(std::ostream& out, const Member& obj)
{
  obj.printTo(out);
  return out;
}
...
inline std::ostream& operator<<(std::ostream& out, const ServerException& obj)
{
  obj.printTo(out);
  return out;
}

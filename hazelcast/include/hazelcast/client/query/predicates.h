...
/**
 * This is a marker class for Predicate classes. All predicate classes shall
 * extend this class. This class also indicates that a Java implementation is
 * required at the server side.
 */
...
{
protected:
    explicit named_predicate(hazelcast_client& client,
...
public:
     ...
     */
    template<typename T>
    equal_predicate(hazelcast_client& client,
                    const std::string& attribute_name,
                    const T& value)
...
public:
     ...
     */
    template<typename T>
    not_equal_predicate(hazelcast_client& client,
                        const std::string& attribute_name,
                        const T& value)
      : named_predicate(client, attribute_name)
    {
...
public:
     ...
     * @param less If true, allow "less than" matching otherwise do "greater
     * than" matching
     */
    template<typename T>
...
public:
    /**
     * @param javaClassName The name of the java class as identified by
     * Class.get_name() in java.
     */
    instance_of_predicate(hazelcast_client& client,
...
public:
     ...
     */
    template<typename... Args>
    in_predicate(hazelcast_client& client,
                 const std::string& attribute_name,
                 const Args&... values)
...
template<>
struct hz_serializer<query::true_predicate>
  : public BasePredicateSerializer<query::true_predicate>
{
    /**
     * @return class id
     */
...
template<>
struct hz_serializer<query::like_predicate>
  : public BasePredicateSerializer<query::like_predicate>
{
    /**
     * @return class id
     */
...
template<>
struct hz_serializer<query::in_predicate>
  : public BasePredicateSerializer<query::in_predicate>
{
    /**
     * @return class id
     */
...
template<>
struct hz_serializer<query::and_predicate>
  : public BasePredicateSerializer<query::and_predicate>
{
    /**
     * @return class id
     */
...
template<>
struct hz_serializer<query::or_predicate>
  : public BasePredicateSerializer<query::or_predicate>
{
    /**
     * @return class id
     */
...
template<>
struct hz_serializer<query::not_predicate>
  : public BasePredicateSerializer<query::not_predicate>
{
    /**
     * @return class id
     */

 ...
 */
#ifndef HAZELCAST_CLIENT_PROTOCOL_CODEC_ATOMICREFERENCEALTERANDGETCODEC_H_
#define HAZELCAST_CLIENT_PROTOCOL_CODEC_ATOMICREFERENCEALTERANDGETCODEC_H_
...
namespace hazelcast {
    namespace client {
        ...
        namespace protocol {
            namespace codec {
                class HAZELCAST_API AtomicReferenceAlterAndGetCodec {
                public:
                    ...
                    private:
                        // Preventing public access to constructors
                        AtomicReferenceAlterAndGetCodec ();
                };
            }
        }
    }
...
#endif /* HAZELCAST_CLIENT_PROTOCOL_CODEC_ATOMICREFERENCEALTERANDGETCODEC_H_ */

 ...
 */
#ifndef HAZELCAST_CLIENT_INTERNAL_UTIL_EXECUTOR_COMPLETEDFUTURE_H_
#define HAZELCAST_CLIENT_INTERNAL_UTIL_EXECUTOR_COMPLETEDFUTURE_H_
...
#endif /* HAZELCAST_CLIENT_INTERNAL_UTIL_EXECUTOR_COMPLETEDFUTURE_H_ */

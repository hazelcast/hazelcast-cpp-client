 ...
 */
#ifndef HAZELCAST_CLIENT_MIXEDQUEUE_H_
#define HAZELCAST_CLIENT_MIXEDQUEUE_H_
...
namespace hazelcast {
    namespace client {
        class MixedItemListener;
        
        /**
        * Concurrent, blocking, distributed, observable, client queue.
        *
        */
        class HAZELCAST_API MixedQueue : public proxy::IQueueImpl {
        ...
        public:
            ...
            */
            void clear();
        private:
            MixedQueue(const std::string& instanceName, spi::ClientContext *context);
        };
    }
}
...
#endif /* HAZELCAST_CLIENT_MIXEDQUEUE_H_ */

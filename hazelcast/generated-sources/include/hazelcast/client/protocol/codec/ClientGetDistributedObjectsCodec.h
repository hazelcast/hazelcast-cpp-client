 ...
 */
#ifndef HAZELCAST_CLIENT_PROTOCOL_CODEC_CLIENTGETDISTRIBUTEDOBJECTSCODEC_H_
#define HAZELCAST_CLIENT_PROTOCOL_CODEC_CLIENTGETDISTRIBUTEDOBJECTSCODEC_H_
...
namespace hazelcast {
    namespace client {
        ...
        namespace protocol {
            namespace codec {
                class HAZELCAST_API ClientGetDistributedObjectsCodec {
                public:
                    ...
                    class HAZELCAST_API ResponseParameters {
                        public:
                            ...
                            std::vector<impl::DistributedObjectInfo > response;
...
#endif /* HAZELCAST_CLIENT_PROTOCOL_CODEC_CLIENTGETDISTRIBUTEDOBJECTSCODEC_H_ */

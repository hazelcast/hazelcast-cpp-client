 ...
 */
#ifndef HAZELCAST_CLIENT_PROTOCOL_CODEC_CLIENTREMOVEALLLISTENERSCODEC_H_
#define HAZELCAST_CLIENT_PROTOCOL_CODEC_CLIENTREMOVEALLLISTENERSCODEC_H_
...
namespace hazelcast {
    namespace client {
        ...
        namespace protocol {
            namespace codec {
                class HAZELCAST_API ClientRemoveAllListenersCodec {
                public:
...
#endif /* HAZELCAST_CLIENT_PROTOCOL_CODEC_CLIENTREMOVEALLLISTENERSCODEC_H_ */

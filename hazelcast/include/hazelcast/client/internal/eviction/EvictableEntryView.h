...
namespace eviction {
/**
 * Contract point (from the end user perspective) for serving/accessing entries
 * that can be evicted.
 *
...
public:
    ...
    /**
     * Gets the creation time of this {@link EvictableEntryView} in
     * milliseconds.
     *
     * @return the creation time of this {@link EvictableEntryView} in
     * milliseconds
     */
    virtual int64_t get_creation_time() const = 0;

    /**
     * Gets the latest access time difference of this {@link EvictableEntryView}
     * in milliseconds.
     *
     * @return the latest access time of this {@link EvictableEntryView} in
     * milliseconds
     */

...
private:
    ...
    boost::future<int64_t> alter_data(client::serialization::pimpl::data& function_data,
                                      alter_result_type result_type);

    boost::future<boost::optional<client::serialization::pimpl::data>> apply_data(
...
private:
    ...
    boost::future<boost::optional<client::serialization::pimpl::data>> get_and_set_data(
      const client::serialization::pimpl::data& new_value_data);
    ...
    boost::future<boost::optional<client::serialization::pimpl::data>> alter_and_get_data(
      const client::serialization::pimpl::data& function_data);

    boost::future<boost::optional<client::serialization::pimpl::data>> get_and_alter_data(
      const client::serialization::pimpl::data& function_data);

    boost::future<boost::optional<client::serialization::pimpl::data>> apply_data(
      const client::serialization::pimpl::data& function_data);

    boost::future<boost::optional<client::serialization::pimpl::data>> invoke_apply(
      const client::serialization::pimpl::data function_data,
...
public:
                                          ...
                                          int32_t permits = 1)
    {
        ...
        return try_acquire_for(
          std::chrono::duration_cast<std::chrono::milliseconds>(abs_time - now), permits);
    }

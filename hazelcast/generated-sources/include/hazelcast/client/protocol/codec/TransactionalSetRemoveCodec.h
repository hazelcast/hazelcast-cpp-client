 ...
 */
#ifndef HAZELCAST_CLIENT_PROTOCOL_CODEC_TRANSACTIONALSETREMOVECODEC_H_
#define HAZELCAST_CLIENT_PROTOCOL_CODEC_TRANSACTIONALSETREMOVECODEC_H_
...
#include "hazelcast/client/protocol/codec/TransactionalSetMessageType.h"
            ...
            namespace codec {
                ...
                public:
                    ...
                    class HAZELCAST_API RequestParameters {
                        public:
                            static const enum TransactionalSetMessageType TYPE;
...
#endif /* HAZELCAST_CLIENT_PROTOCOL_CODEC_TRANSACTIONALSETREMOVECODEC_H_ */

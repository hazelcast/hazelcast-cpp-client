 ...
 * time see that the there is space and do a next. But any following invocation
 * needs to wait till there is is capacity.
 */
class HAZELCAST_API CallIdSequenceWithBackpressure
  : public AbstractCallIdSequence
{
public:
    CallIdSequenceWithBackpressure(int32_t max_concurrent_invocations,

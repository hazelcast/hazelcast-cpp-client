...
int32_t
EmployeeEntryComparator::compare(
...
int32_t
EmployeeEntryKeyComparator::compare(
  const std::pair<const int32_t*, const employee*>* lhs,
  const std::pair<const int32_t*, const employee*>* rhs) const
{
...
bool
operator==(const TestCustomXSerializable& lhs,
...
{
    return lhs.l == rhs.l && lhs.c == rhs.c && lhs.p == rhs.p &&
           lhs.k == rhs.k && lhs.s == rhs.s && lhs.ds == rhs.ds;
}
...
{
    return lhs.bb == rhs.bb && lhs.ba == rhs.ba && lhs.cc == rhs.cc &&
           lhs.ss == rhs.ss && lhs.ii == rhs.ii && lhs.ll == rhs.ll &&
           lhs.ff == rhs.ff && lhs.dd == rhs.dd &&
...
{
    return lhs.b == rhs.b && lhs.boolean == rhs.boolean && lhs.c == rhs.c &&
           lhs.s == rhs.s && lhs.i == rhs.i && lhs.l == rhs.l &&
           lhs.f == rhs.f && lhs.d == rhs.d && lhs.str == rhs.str &&
           lhs.p == rhs.p;
}
...
bool
operator==(const ChildTemplatedPortable1& lhs,
...
bool
operator==(const ChildTemplatedPortable2& lhs,
...
void
hz_serializer<test::employee>::write_portable(const test::employee& object,
...
hz_serializer<test::EmployeeEntryComparator>::get_factory_id()
{
    return static_cast<int32_t>(
      test::test_serialization_constants::EMPLOYEE_FACTORY);
}
...
{
    return static_cast<int32_t>(
      test::test_serialization_constants::TEST_MAIN_PORTABLE);
}

void
hz_serializer<test::TestMainPortable>::write_portable(
  const test::TestMainPortable& object,
...
hz_serializer<test::TestMainPortable>::read_portable(
...
{
    return static_cast<int32_t>(
      test::test_serialization_constants::TEST_RAW_DATA_PORTABLE);
}

void
hz_serializer<test::TestRawDataPortable>::write_portable(
  const test::TestRawDataPortable& object,
  serialization::portable_writer& writer)
{
...
hz_serializer<test::TestRawDataPortable>::read_portable(
  serialization::portable_reader& reader)
{
...
{
    return static_cast<int32_t>(
      test::test_serialization_constants::TEST_DATA_FACTORY);
}
...
{
    return static_cast<int32_t>(
      test::test_serialization_constants::TEST_DATA_SERIALIZABLE);
}

void
hz_serializer<test::TestDataSerializable>::write_data(
  const test::TestDataSerializable& object,
...
hz_serializer<test::TestDataSerializable>::read_data(
...
{
    return static_cast<int32_t>(
      test::test_serialization_constants::TEST_NAMED_PORTABLE);
}

void
hz_serializer<test::TestNamedPortable>::write_portable(
  const test::TestNamedPortable& object,
  portable_writer& writer)
{
...
{
    return static_cast<int32_t>(
      test::test_serialization_constants::TEST_INNER_PORTABLE);
}

void
hz_serializer<test::TestInnerPortable>::write_portable(
  const test::TestInnerPortable& object,
  portable_writer& writer)
{
...
hz_serializer<test::TestInnerPortable>::read_portable(portable_reader& reader)
{
    ...
    object.string_vector =
      *reader.read<std::vector<std::string>>("stringVector");
...
void
hz_serializer<test::TestNamedPortableV2>::write_portable(
  const test::TestNamedPortableV2& object,
  portable_writer& writer)
{
    writer.write("name", object.name);
    writer.write<int32_t>("myint", object.k);
...
void
hz_serializer<test::TestNamedPortableV3>::write_portable(
  const test::TestNamedPortableV3& object,
  portable_writer& writer)
{
    writer.write("name", object.name);
...
{
    return static_cast<int32_t>(
      test::test_serialization_constants::TEST_INVALID_WRITE_PORTABLE);
}
...
hz_serializer<test::TestInvalidWritePortable>::read_portable(
...
{
    return static_cast<int32_t>(
      test::test_serialization_constants::TEST_INVALID_READ_PORTABLE);
}
...
hz_serializer<test::TestInvalidReadPortable>::read_portable(
  portable_reader& reader)
{
...
void
hz_serializer<test::TestCustomPerson>::write(
  const test::TestCustomPerson& object,
...
void
hz_serializer<test::TestCustomXSerializable>::write(
  const test::TestCustomXSerializable& object,
  object_data_output& out)
{
...
{
    return static_cast<int32_t>(
      test::test_serialization_constants::CHILD_TEMPLATED_PORTABLE_1);
}
...
hz_serializer<test::ChildTemplatedPortable1>::read_portable(
  portable_reader& reader)
{
...
{
    return static_cast<int32_t>(
      test::test_serialization_constants::CHILD_TEMPLATED_PORTABLE_2);
}
...
hz_serializer<test::ChildTemplatedPortable2>::read_portable(
  portable_reader& reader)
{

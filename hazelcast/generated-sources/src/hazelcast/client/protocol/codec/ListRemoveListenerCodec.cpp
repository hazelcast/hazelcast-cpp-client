    ...
    namespace client {
        namespace protocol {
            namespace codec {
                ...
                std::auto_ptr<ClientMessage> ListRemoveListenerCodec::encodeRequest(
                ...
                ListRemoveListenerCodec::ResponseParameters::ResponseParameters(ClientMessage &clientMessage) {
                    if (RESPONSE_TYPE != clientMessage.getMessageType()) {
                        throw exception::UnexpectedMessageTypeException(
                                "ListRemoveListenerCodec::ResponseParameters::decode", clientMessage.getMessageType(),
                                RESPONSE_TYPE);
                    }
                ...
                ListRemoveListenerCodec::ResponseParameters::ResponseParameters(
                        const ListRemoveListenerCodec::ResponseParameters &rhs) {

...
int main() {
    ...
    std::map<std::string, hazelcast::util::SharedPtr<int> > result =
    ...
    for (std::map<std::string, hazelcast::util::SharedPtr<int> >::const_iterator it = result.begin(); it != result.end(); ++it) {
